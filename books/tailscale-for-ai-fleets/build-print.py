...
def extract_main(path):
    ...
    # Open all <details> elements so troubleshooting answers are visible in the PDF
...
<head>
  ...
  <style>
    ...
    /* ── Troubleshooting: force answers open ── */
    ...
    /* ── Arch diagram ── */
    .arch-diagram { font-size: 8pt !important; line-height: 1.4 !important; padding: 12px !important; }
...
def main():
    ...
    print("\nTo generate PDF:")
    print("  Open dist/print.html in Chrome → Print → Save as PDF")
    print("  Or: python3 build-print.py && <weasyprint/chromium headless>")
